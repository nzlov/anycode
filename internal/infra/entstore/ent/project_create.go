...
func (_c *ProjectCreate) SetIsGit(v bool) *ProjectCreate {
	_c.mutation.SetIsGit(v)
	return _c
}

// SetNillableIsGit sets the "is_git" field if the given value is not nil.
func (_c *ProjectCreate) SetNillableIsGit(v *bool) *ProjectCreate {
	if v != nil {
		_c.SetIsGit(*v)
	}
	return _c
...
func (_c *ProjectCreate) SetNillableDefaultWorkflowID(v *string) *ProjectCreate {
	if v != nil {
