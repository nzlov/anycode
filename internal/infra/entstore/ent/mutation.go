...
// MCPEntryMutation represents an operation that mutates the MCPEntry nodes in the graph.
type MCPEntryMutation struct {
	config
	op            Op
	typ           string
	id            *string
	...
	oldValue      func(context.Context) (*MCPEntry, error)
	predicates    []predicate.MCPEntry
}

var _ ent.Mutation = (*MCPEntryMutation)(nil)

// mcpentryOption allows management of the mutation configuration using functional options.
type mcpentryOption func(*MCPEntryMutation)

// newMCPEntryMutation creates new mutation for the MCPEntry entity.
func newMCPEntryMutation(c config, op Op, opts ...mcpentryOption) *MCPEntryMutation {
	m := &MCPEntryMutation{
		config:        c,
		op:            op,
		typ:           TypeMCPEntry,
...
// withMCPEntryID sets the ID field of the mutation.
func withMCPEntryID(id string) mcpentryOption {
	return func(m *MCPEntryMutation) {
		var (
			err   error
			once  sync.Once
			value *MCPEntry
		)
		m.oldValue = func(ctx context.Context) (*MCPEntry, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().MCPEntry.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withMCPEntry sets the old MCPEntry of the mutation.
func withMCPEntry(node *MCPEntry) mcpentryOption {
	return func(m *MCPEntryMutation) {
		m.oldValue = func(context.Context) (*MCPEntry, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m MCPEntryMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m MCPEntryMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of MCPEntry entities.
func (m *MCPEntryMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *MCPEntryMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *MCPEntryMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().MCPEntry.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *MCPEntryMutation) SetScopeKind(s string) {
	m.scope_kind = &s
}

// ScopeKind returns the value of the "scope_kind" field in the mutation.
func (m *MCPEntryMutation) ScopeKind() (r string, exists bool) {
	v := m.scope_kind
	if v == nil {
		return
	}
...
// OldScopeKind returns the old "scope_kind" field's value of the MCPEntry entity.
// If the MCPEntry object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MCPEntryMutation) OldScopeKind(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MCPEntryMutation) ResetScopeKind() {
	m.scope_kind = nil
}

// SetScopeID sets the "scope_id" field.
func (m *MCPEntryMutation) SetScopeID(s string) {
	m.scope_id = &s
}

// ScopeID returns the value of the "scope_id" field in the mutation.
func (m *MCPEntryMutation) ScopeID() (r string, exists bool) {
	v := m.scope_id
	if v == nil {
		return
	}
...
// OldScopeID returns the old "scope_id" field's value of the MCPEntry entity.
// If the MCPEntry object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MCPEntryMutation) OldScopeID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MCPEntryMutation) ResetScopeID() {
	m.scope_id = nil
}

// SetName sets the "name" field.
func (m *MCPEntryMutation) SetName(s string) {
	m.name = &s
}

// Name returns the value of the "name" field in the mutation.
func (m *MCPEntryMutation) Name() (r string, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
// OldName returns the old "name" field's value of the MCPEntry entity.
// If the MCPEntry object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MCPEntryMutation) OldName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MCPEntryMutation) ResetName() {
	m.name = nil
}

// SetDefinition sets the "definition" field.
func (m *MCPEntryMutation) SetDefinition(value *mcp.Definition) {
	m.definition = &value
}

// Definition returns the value of the "definition" field in the mutation.
func (m *MCPEntryMutation) Definition() (r *mcp.Definition, exists bool) {
	v := m.definition
	if v == nil {
		return
	}
...
// OldDefinition returns the old "definition" field's value of the MCPEntry entity.
// If the MCPEntry object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MCPEntryMutation) OldDefinition(ctx context.Context) (v *mcp.Definition, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MCPEntryMutation) ClearDefinition() {
	m.definition = nil
	m.clearedFields[mcpentry.FieldDefinition] = struct{}{}
}

// DefinitionCleared returns if the "definition" field was cleared in this mutation.
func (m *MCPEntryMutation) DefinitionCleared() bool {
	_, ok := m.clearedFields[mcpentry.FieldDefinition]
	return ok
}

// ResetDefinition resets all changes to the "definition" field.
func (m *MCPEntryMutation) ResetDefinition() {
	m.definition = nil
	delete(m.clearedFields, mcpentry.FieldDefinition)
}

// SetEnabled sets the "enabled" field.
func (m *MCPEntryMutation) SetEnabled(b bool) {
	m.enabled = &b
}

// Enabled returns the value of the "enabled" field in the mutation.
func (m *MCPEntryMutation) Enabled() (r bool, exists bool) {
	v := m.enabled
	if v == nil {
		return
	}
...
// OldEnabled returns the old "enabled" field's value of the MCPEntry entity.
// If the MCPEntry object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *MCPEntryMutation) OldEnabled(ctx context.Context) (v *bool, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *MCPEntryMutation) ClearEnabled() {
	m.enabled = nil
	m.clearedFields[mcpentry.FieldEnabled] = struct{}{}
}

// EnabledCleared returns if the "enabled" field was cleared in this mutation.
func (m *MCPEntryMutation) EnabledCleared() bool {
	_, ok := m.clearedFields[mcpentry.FieldEnabled]
	return ok
}

// ResetEnabled resets all changes to the "enabled" field.
func (m *MCPEntryMutation) ResetEnabled() {
	m.enabled = nil
	delete(m.clearedFields, mcpentry.FieldEnabled)
}

// Where appends a list predicates to the MCPEntryMutation builder.
func (m *MCPEntryMutation) Where(ps ...predicate.MCPEntry) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the MCPEntryMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *MCPEntryMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.MCPEntry, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *MCPEntryMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *MCPEntryMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (MCPEntry).
func (m *MCPEntryMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *MCPEntryMutation) Fields() []string {
	fields := make([]string, 0, 5)
	if m.scope_kind != nil {
		fields = append(fields, mcpentry.FieldScopeKind)
	}
	if m.scope_id != nil {
		fields = append(fields, mcpentry.FieldScopeID)
	}
	if m.name != nil {
		fields = append(fields, mcpentry.FieldName)
	}
	if m.definition != nil {
		fields = append(fields, mcpentry.FieldDefinition)
	}
	if m.enabled != nil {
		fields = append(fields, mcpentry.FieldEnabled)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *MCPEntryMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *MCPEntryMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case mcpentry.FieldScopeKind:
	...
	return nil, fmt.Errorf("unknown MCPEntry field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MCPEntryMutation) SetField(name string, value ent.Value) error {
	switch name {
	case mcpentry.FieldScopeKind:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown MCPEntry field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *MCPEntryMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *MCPEntryMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MCPEntryMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown MCPEntry numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *MCPEntryMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(mcpentry.FieldDefinition) {
		fields = append(fields, mcpentry.FieldDefinition)
	}
	if m.FieldCleared(mcpentry.FieldEnabled) {
		fields = append(fields, mcpentry.FieldEnabled)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *MCPEntryMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *MCPEntryMutation) ClearField(name string) error {
	switch name {
	case mcpentry.FieldDefinition:
		m.ClearDefinition()
		return nil
	...
	return fmt.Errorf("unknown MCPEntry nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *MCPEntryMutation) ResetField(name string) error {
	switch name {
	case mcpentry.FieldScopeKind:
		m.ResetScopeKind()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *MCPEntryMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *MCPEntryMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *MCPEntryMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *MCPEntryMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *MCPEntryMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *MCPEntryMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *MCPEntryMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown MCPEntry unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *MCPEntryMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown MCPEntry edge %s", name)
}
