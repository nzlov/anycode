...
func init() {
	...
	processrunDescCodexSessionID := processrunFields[4].Descriptor()
	...
	processrunDescFailureReason := processrunFields[7].Descriptor()
	...
	processrunDescStartedAt := processrunFields[8].Descriptor()
	...
	promptappendDescArtifactIds := promptappendFields[4].Descriptor()
	...
	questionrequestFields := schema.QuestionRequest{}.Fields()
	_ = questionrequestFields
	// questionrequestDescSessionID is the schema descriptor for session_id field.
	questionrequestDescSessionID := questionrequestFields[1].Descriptor()
	// questionrequest.SessionIDValidator is a validator for the "session_id" field. It is called by the builders before save.
	questionrequest.SessionIDValidator = questionrequestDescSessionID.Validators[0].(func(string) error)
	// questionrequestDescOriginProcessRunID is the schema descriptor for origin_process_run_id field.
	questionrequestDescOriginProcessRunID := questionrequestFields[2].Descriptor()
	// questionrequest.DefaultOriginProcessRunID holds the default value on creation for the origin_process_run_id field.
	questionrequest.DefaultOriginProcessRunID = questionrequestDescOriginProcessRunID.Default.(string)
	// questionrequestDescStatus is the schema descriptor for status field.
	questionrequestDescStatus := questionrequestFields[3].Descriptor()
	// questionrequest.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	questionrequest.StatusValidator = questionrequestDescStatus.Validators[0].(func(string) error)
	// questionrequestDescQuestions is the schema descriptor for questions field.
	questionrequestDescQuestions := questionrequestFields[4].Descriptor()
	// questionrequest.DefaultQuestions holds the default value on creation for the questions field.
	questionrequest.DefaultQuestions = questionrequestDescQuestions.Default.([]map[string]interface{})
	// questionrequestDescAnswers is the schema descriptor for answers field.
	questionrequestDescAnswers := questionrequestFields[5].Descriptor()
	// questionrequest.DefaultAnswers holds the default value on creation for the answers field.
	questionrequest.DefaultAnswers = questionrequestDescAnswers.Default.([]map[string]interface{})
	// questionrequestDescCancelReason is the schema descriptor for cancel_reason field.
	questionrequestDescCancelReason := questionrequestFields[6].Descriptor()
	// questionrequest.DefaultCancelReason holds the default value on creation for the cancel_reason field.
	questionrequest.DefaultCancelReason = questionrequestDescCancelReason.Default.(string)
	// questionrequestDescCreatedAt is the schema descriptor for created_at field.
	questionrequestDescCreatedAt := questionrequestFields[7].Descriptor()
	// questionrequest.DefaultCreatedAt holds the default value on creation for the created_at field.
	questionrequest.DefaultCreatedAt = questionrequestDescCreatedAt.Default.(func() time.Time)
	...
	entsessionDescMode := entsessionFields[4].Descriptor()
	...
	entsessionDescStatus := entsessionFields[5].Descriptor()
	...
	entsessionDescPriority := entsessionFields[6].Descriptor()
	...
	entsessionDescBaseBranch := entsessionFields[8].Descriptor()
	...
	entsessionDescWorktreePath := entsessionFields[9].Descriptor()
	...
	entsessionDescWorktreeBranch := entsessionFields[10].Descriptor()
	...
	entsessionDescWorktreeBaseCommit := entsessionFields[11].Descriptor()
	...
	entsessionDescWorktreeHeadCommit := entsessionFields[12].Descriptor()
	...
	entsessionDescWorktreeCleanupStatus := entsessionFields[13].Descriptor()
	...
	entsessionDescWorktreeCleanupAttempts := entsessionFields[14].Descriptor()
	...
	entsessionDescWorktreeOwnershipToken := entsessionFields[15].Descriptor()
	...
	entsessionDescWorktreeCleanupErrorCode := entsessionFields[21].Descriptor()
	...
	entsessionDescWorktreeCleanupError := entsessionFields[22].Descriptor()
	...
	// entsessionDescForkedFromSessionID is the schema descriptor for forked_from_session_id field.
	entsessionDescForkedFromSessionID := entsessionFields[27].Descriptor()
	// entsession.DefaultForkedFromSessionID holds the default value on creation for the forked_from_session_id field.
	entsession.DefaultForkedFromSessionID = entsessionDescForkedFromSessionID.Default.(string)
	// entsessionDescForkedFromCodexSessionID is the schema descriptor for forked_from_codex_session_id field.
	entsessionDescForkedFromCodexSessionID := entsessionFields[28].Descriptor()
	// entsession.DefaultForkedFromCodexSessionID holds the default value on creation for the forked_from_codex_session_id field.
	entsession.DefaultForkedFromCodexSessionID = entsessionDescForkedFromCodexSessionID.Default.(string)
	// entsessionDescCodexModel is the schema descriptor for codex_model field.
	entsessionDescCodexModel := entsessionFields[29].Descriptor()
	...
	entsessionDescReasoningEffort := entsessionFields[30].Descriptor()
	...
	entsessionDescPermissionMode := entsessionFields[31].Descriptor()
	...
	entsessionDescFastMode := entsessionFields[32].Descriptor()
	...
	entsessionDescArtifactCount := entsessionFields[35].Descriptor()
	...
	entsessionDescFilesChanged := entsessionFields[36].Descriptor()
	...
	entsessionDescQueueKind := entsessionFields[38].Descriptor()
	...
	entsessionDescQueuePriority := entsessionFields[39].Descriptor()
	...
	entsessionDescQueueReviewAfterReuseFailure := entsessionFields[41].Descriptor()
	...
	entsessionDescQueueNodeRunID := entsessionFields[42].Descriptor()
	...
	entsessionDescQueuePrompt := entsessionFields[43].Descriptor()
	...
	entsessionDescQueueResumeCodexSessionID := entsessionFields[44].Descriptor()
	...
	entsessionDescQueueResumeOfProcessRunID := entsessionFields[45].Descriptor()
	...
	entsessionDescWorkflowDefinitionID := entsessionFields[46].Descriptor()
	...
	entsessionDescWorkflowStatus := entsessionFields[47].Descriptor()
	...
	entsessionDescWorkflowCurrentNodeID := entsessionFields[48].Descriptor()
	...
	entsessionDescWorkflowContext := entsessionFields[49].Descriptor()
	...
	entsessionDescWorkflowPendingApproval := entsessionFields[50].Descriptor()
	...
	entsessionDescCreatedAt := entsessionFields[55].Descriptor()
	...
	entsessionDescUpdatedAt := entsessionFields[56].Descriptor()
	...
	// systemconfigurationDescAgentMaxConcurrent is the schema descriptor for agent_max_concurrent field.
	...
	// systemconfigurationDescSendShortcut is the schema descriptor for send_shortcut field.
	systemconfigurationDescSendShortcut := systemconfigurationFields[3].Descriptor()
	// systemconfiguration.DefaultSendShortcut holds the default value on creation for the send_shortcut field.
	...
	// systemconfigurationDescCodexAutoCompactTokenLimit is the schema descriptor for codex_auto_compact_token_limit field.
	systemconfigurationDescCodexAutoCompactTokenLimit := systemconfigurationFields[5].Descriptor()
	// systemconfiguration.DefaultCodexAutoCompactTokenLimit holds the default value on creation for the codex_auto_compact_token_limit field.
	systemconfiguration.DefaultCodexAutoCompactTokenLimit = systemconfigurationDescCodexAutoCompactTokenLimit.Default.(int)
	// systemconfigurationDescMindMapEnabled is the schema descriptor for mind_map_enabled field.
	systemconfigurationDescMindMapEnabled := systemconfigurationFields[6].Descriptor()
	...
	systemconfigurationDescMindMapMode := systemconfigurationFields[7].Descriptor()
	...
	systemconfigurationDescMindMapLayout := systemconfigurationFields[8].Descriptor()
	...
	systemconfigurationDescMindMapModel := systemconfigurationFields[9].Descriptor()
	...
	systemconfigurationDescMindMapReasoningEffort := systemconfigurationFields[10].Descriptor()
	...
	systemconfigurationDescMindMapMaxConcurrent := systemconfigurationFields[11].Descriptor()
	...
	systemconfigurationDescWallpaperColorScheme := systemconfigurationFields[12].Descriptor()
	...
	systemconfigurationDescBackgroundType := systemconfigurationFields[13].Descriptor()
	...
	systemconfigurationDescSolidTheme := systemconfigurationFields[14].Descriptor()
	...
	systemconfigurationDescBackgroundMask := systemconfigurationFields[15].Descriptor()
	...
	systemconfigurationDescWallpaperID := systemconfigurationFields[16].Descriptor()
	...
	systemconfigurationDescWallpaperFilename := systemconfigurationFields[17].Descriptor()
	...
	systemconfigurationDescWallpaperMimeType := systemconfigurationFields[18].Descriptor()
	...
	systemconfigurationDescUpdatedAt := systemconfigurationFields[19].Descriptor()
